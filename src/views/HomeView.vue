  ...
  <p class=" flex justify-center items-center text-yellow-500 ">
    ...
    <ul class="  text-yellow-500 pl-4">
      ...
      <li>we deliver what you order</li>
                   ...
                   <button class=" transform h-14 bg-blue-700 transition duration-500 hover:scale-125 hover:bg-blue-700 flex justify-center items-center text-white flex-col rounded-md px-5 py-3"><a href="amoskipngeno@yahoo.com" class=""> Click to Hire me</a></button>
   </div>
  </div>
      </aside>
