...
<template>
  ...
  <p class=" flex justify-center items-center text-yellow-500 ">
    ...
    <ul class="  text-yellow-500 pl-4">
      ...
      <li>we deliver what you order</li>
    </ul>
                       
                   </p> 
                   <button class=" transform h-14 bg-blue-700 transition duration-500 hover:scale-125 hover:bg-blue-700 flex justify-center items-center text-white flex-col rounded-md px-5 py-3"><a href="sms:254729492418?body=Hello Amohan,,i need your services">Click to Hire me</a></button>
   </div>
  </div>
      </aside>
      ...
      <div class=" transition-all duration-500 transform hover:opacity-50 pt-1 hover:pb-1">
        ...
        <p class=" bg-white">This is picture of our  brand new machine TATA<br>
